...
class IngredientController {
    ...
    public function store(): void {
        ...
        if (empty($errors)) {
            ...
            $errors['global'] = 'Échec de l\'ajout en base de données. Vérifiez les valeurs saisies.';
        }
        $ingredient = $_POST;
        require_once 'View/back/ingredient/form.php';
    }
    ...
    public function addIngredient(Ingredient $ingredient): bool {
        ...
        try {
            ...
            error_log('Ingredient insert error: ' . $e->getMessage());
            return false;
        }
    }
