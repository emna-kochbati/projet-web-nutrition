...
<head>
    ...
    <!-- Favicon -->
    <link href="/2A35/View/front/assets/img/favicon.ico" rel="icon">
    ...
    <link href="/2A35/View/front/assets/lib/animate/animate.min.css" rel="stylesheet">
    <link href="/2A35/View/front/assets/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="/2A35/View/front/assets/css/bootstrap.min.css" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="/2A35/View/front/assets/css/style.css" rel="stylesheet">
</head>
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="/2A35/View/front/programs.php" class="nav-item nav-link">Programs</a>
