...
<head>
    <meta charset="utf-8">
    <title>EcoNutri - Alimentation Saine & Nutrition Intelligente</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="/2A35/assets/img/favicon.ico" rel="icon">
    ...
    <link href="/2A35/assets/lib/animate/animate.min.css" rel="stylesheet">
    <link href="/2A35/assets/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a href="/2A35/Home" class="navbar-brand ms-4 ms-lg-0">
                <h1 class="fw-bold m-0"><span style="color:#2e7d32;">Eco</span><span class="text-secondary">Nutri</span></h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="/2A35/RecetteFront" class="nav-item nav-link">Recettes</a>
