    ...
    <?php if (!empty($errors)): ?>
        <div class="alert-err">
            ...
            <?php if (!empty($errors['global'])): ?>
                <div style="margin-top:6px;font-weight:700;"><?= htmlspecialchars($errors['global']) ?></div>
            <?php endif; ?>
        </div>
    <?php endif; ?>
        ...
        <div style="margin-top:20px;padding-top:16px;border-top:2px solid var(--border);">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
                <div class="form-group">
                    ...
                    <?php if (isset($errors['proteines'])): ?><span class="err">⚠ <?= htmlspecialchars($errors['proteines']) ?></span><?php endif; ?>
                </div>
                <div class="form-group">
                    ...
                    <?php if (isset($errors['calcium'])): ?><span class="err">⚠ <?= htmlspecialchars($errors['calcium']) ?></span><?php endif; ?>
                </div>
                <div class="form-group">
                    ...
                    <?php if (isset($errors['glucides'])): ?><span class="err">⚠ <?= htmlspecialchars($errors['glucides']) ?></span><?php endif; ?>
                </div>
                <div class="form-group">
                    ...
                    <?php if (isset($errors['lipides'])): ?><span class="err">⚠ <?= htmlspecialchars($errors['lipides']) ?></span><?php endif; ?>
                </div>
            </div>
        </div>
