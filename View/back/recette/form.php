...
.current-img img { width:80px; height:80px; object-fit:cover; border-radius:8px; border:2px solid #ddd; margin-top:6px; }
</style>
    ...
    <form method="POST"
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" id="temps_preparation" name="temps_preparation" min="1"
                       value="<?= htmlspecialchars($recette['temps_preparation'] ?? '') ?>" placeholder="Ex: 30">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" id="calories" name="calories" min="0"
                       value="<?= htmlspecialchars($recette['calories'] ?? '') ?>" placeholder="Ex: 350">
            </div>
            <div class="form-group">
